...
|---|---------|-------------|--------|
| 1a | [Backend Core](milestone-1a-backend-core.md) | File reading, encoding, diff compute | Not Started |
...
| 1e | [File Picker](milestone-1e-file-picker.md) | Open dialog for file selection | Not Started |
